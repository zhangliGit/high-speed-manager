        ...
        <div className = "co-pd-a02">
          {
            this.props.list.map((item, index) => {
              return (
                  <div className = "co-bg-0 co-pd-a04 co-mg-b02"  key = { index } onClick = { this.goDetail.bind(this, item.id)}>
                    ...
                    <div className = "co-flex co-pd-tb04 co-cl-2 co-fs-01">
                      ...
                      <div style = { _styles.slideRit }>{ item.level }</div>
                    </div>
                    <div className = "co-flex co-pd-tb04 co-jsb">
                      <div>{ item.gCode }</div>
                      <div style = { _styles.slideRit }>可抢票</div>
                    </div>
                  </div>
              )
            })
